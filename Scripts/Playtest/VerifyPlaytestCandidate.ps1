...
foreach ($RequiredResult in @(
	...
	'Wisp rule healing_latched:\s+PASS',
	'Wisp rule healing_enemy:\s+PASS',
	'Wisp rule carried_enemy:\s+PASS',
	'Wisp rule eluna_shift_pickup:\s+PASS',
...
$Summary = @(
	...
	"Wisp lifecycle rules: PASS (12/12: natural, ally/enemy priority, healing persistence/cancellation, carried exception, Eluna Shift/passive pickup, CC drop, Eluna R revive)",
